...
public interface InsumoServiceInterface {
    ...
    Page<Insumo> filterSupplies(Long id, String nombre, Boolean esComplemento, Baja_Alta estado, Long umId, Pageable page) throws Exception;

    Insumo findByID(Long ID) throws Exception;

    Boolean verificarAsociacion(Long id) throws Exception;
}
